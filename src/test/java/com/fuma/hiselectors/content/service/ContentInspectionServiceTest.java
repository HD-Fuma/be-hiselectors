    ...
    void mapsOrderedTextsAndMediaFromOneBatchQuery() {
        ...
        when(mediaRepository
                .findAllByContentVersionIdInOrderByContentVersionIdAscSequenceNoAsc(
                        List.of(101L)))
                .thenReturn(List.of(
                        media(101L, ContentMedia.MediaType.TEXT, null, null, 0, "제목"),
                        media(101L, ContentMedia.MediaType.TEXT, null, null, 1, "본문"),
                        media(101L, ContentMedia.MediaType.IMAGE,
                                "https://cdn.example.com/image.jpg", "image-1", 2, null),
                        media(101L, ContentMedia.MediaType.VIDEO, null, "video-1", 3, null)));
        ...
        assertThat(result.getContent()).singleElement().satisfies(item -> {
            ...
            assertThat(item.media())
                    ...
                    .containsExactly(
                            tuple(ContentMedia.MediaType.IMAGE,
                                    "https://cdn.example.com/image.jpg", "image-1", 2),
                            tuple(ContentMedia.MediaType.VIDEO, null, "video-1", 3));
        });
